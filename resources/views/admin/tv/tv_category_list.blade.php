        ...
        <div class="card">
          ...
          <div class="card-body">	
            <div class="pull-right">
              <div class="buttons"> 
                  <button class="btn btn-primary text-light" data-toggle="modal" data-target="#categoryModal" data-whatever="@mdo">Add TV Category</button>
              </div>
            </div>
        ...
        {{ csrf_field() }}
          <div class="modal-body">
            <div class="form-group">
                ...
                <input id="category_name" name="category_name" type="text" class="form-control form-control-danger" placeholder="Enter TV Category Name">
              </div>

              <div class="form-group">
                  <label for="categoryprofile">Category Icon</label>
                  <input type="file" class="form-control-file file-upload custom_image valid" id="category_image" name="category_image" aria-required="true" aria-invalid="false">
                  <label id="category_image-error" class="error image_error" for="category_image" style="display: none;"></label>
...
$(document).ready(function (){
  ...
  $("#category-listing").on("click", ".UpdateTVCategory", function() {
      ...
      $('.preview_categoryimg').html('<div class=""><img src="'+image+'" width="150" height="150"/> </div>');
  });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success == 1) {
                      ...
                      swal("Confirm!", "TV Category has not been deleted!", "error");
                    }
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    alert(errorThrown);
