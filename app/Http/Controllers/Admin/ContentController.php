...
class ContentController extends Controller
{
	...
	public function deleteContentSubtitles(Request $request){
		...
		if($SubtitlesData && file_exists(public_path('uploads/').$SubtitlesData->subtitle_file)){
